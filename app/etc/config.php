...
return [
    'modules' => [
        ...
        'Klarna_Kp' => 1,
        'Lobbster_CustomMiniCart' => 1,
        'Magento_PaypalReCaptcha' => 1,
        'MSP_TwoFactorAuth' => 1,
        'Temando_ShippingRemover' => 1,
        'Trienekens_AjaxInfiniteScroll' => 0,
        'Trienekens_Catalog' => 0,
        'Trienekens_CatalogStock' => 0,
        'Trienekens_CategoryDescription' => 0,
        'Trienekens_Csp' => 0,
        'Trienekens_CustomFee' => 0,
        'Trienekens_Customization' => 0,
        'Trienekens_EmailAttachments' => 0,
        'Trienekens_LinkedProduct' => 0,
        'Trienekens_OrderProcess' => 0,
        'Trienekens_RecaptchaBlock' => 0,
        'Trienekens_RelatedBrands' => 0,
        'Trienekens_SpecialCat' => 0,
        'Trienekens_UrlTrailer' => 0,
        'Trienekens_VatChecker' => 0,
        'Trienekens_Verspaning' => 0,
        'Trienekens_WeltPixelAddToCartFix' => 0,
        'Vertex_Tax' => 1,
